...
public class PatchTest
{
   ...
   public void testCustomerResource() throws Exception
   {
      ...
      HttpPost post = new HttpPost("http://localhost:8080/ex04_1/services/customers");
      ...
      HttpPatch patch = new HttpPatch("http://localhost:8080/ex04_1/services/customers/1");
      ...
      HttpGet get = new HttpGet("http://localhost:8080/ex04_1/services/customers/1");
