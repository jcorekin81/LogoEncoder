...
import command_line_interface.Command_Line_Interface;
...
public class IJ {
	...
	private static Frame base=null;
	private static Panel statusBar=null;
	private static Label statusLine=null;
	private static Dimension StatusBarSize = new Dimension(Command_Line_Interface.x/3, Command_Line_Interface.y/30);
	...
	*/
    ...
    private static void initStatusBar(){
		...
		//System.out.println("progressBar: "+progressBar.toString());
