...
public class MultipartRequest extends HttpServletRequestWrapper {
        ...
        throws ServletException, IOException
    {
        ...
        System.out.println("Creating new MultipartMap");
        this.multipartMap = new MultipartMap(request, location);
        System.out.println("New multipartMap created");
    }
    ...
    public String getParameter(String name) {
    	System.out.println("Getting mutlipart parameter:"+name);
        return multipartMap.getParameter(name);
    }

    @Override
    public String[] getParameterValues(String name) {
    	System.out.println("getting mutlipart parameterValues for: "+name);
        return multipartMap.getParameterValues(name);
    }

    @Override
    public Enumeration<String> getParameterNames() {
    	System.out.println("Getting mutlipart parameterNames");
        return multipartMap.getParameterNames();
    }

    @Override
    public Map<String, String[]> getParameterMap() {
    	System.out.println("Getting mutlipart parameterMap");
    ...
    public File getFile(String name) {
    	System.out.println("Getting mutlipart parameterFile");
