 ...
 *
 * @author BalusC
 * @author Jason Corekin (Altered by)
...
public class MultipartMap extends HashMap<String, Object> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4612429648231133087L;
	...
	public MultipartMap(HttpServletRequest multipartRequest, Servlet servlet)
		...
		System.out.println("Called 1st multipartMap Constructor");
			}
	...
	public MultipartMap(HttpServletRequest multipartRequest, String location)
		...
		System.out.println("Called 2nd multipartMap Constructor");
			}
	...
	{
		System.out.println("Called Global multipartMap Constructor");
		...
		for (Part part : multipartRequest.getParts()) {
			...
			multipartRequest.setAttribute("location", location);
			
			if (filename == null) {
				processTextPart(part);
			} else if (!filename.isEmpty()) {
				String fieldname = getName(part);
				if(fieldname!=null){
					if(fieldname.equals("orig")){

						String origIndvTag = new Double(Math.random()).toString();
						System.out.println("Setting origIndvTag attribute to: "+origIndvTag);
						multipartRequest.setAttribute("origIndvTag", origIndvTag);
						System.out.println("Writing file "+location+origIndvTag+"_orig.jpg");
						part.write(location+origIndvTag+"_orig.jpg");
					}
					if(fieldname.equals("logo")){

						String logoIndvTag = new Double(Math.random()).toString();
						System.out.println("Setting logoIndvTag attribute to: "+logoIndvTag);
						multipartRequest.setAttribute("logoIndvTag", logoIndvTag);
						System.out.println("Writing file "+location+logoIndvTag+"_logo.jpg");
						part.write(location+logoIndvTag+"_logo.jpg");
					}
				}
			}
		}

		System.out.println("Finished Global multipartMap Constructor");
	}
	...
	public Object get(Object key) {
		System.out.println("Getting key:" + key+" from MultipartMap");
	...
	public String getParameter(String name) {
		System.out.println("Getting parameter: "+name+" from MultipartMap");
	...
	public String[] getParameterValues(String name) {
		System.out.println("Getting value: "+name+" from MultipartMap");
		Object value = super.get(name);
		if (value instanceof File) {
	...
	public Enumeration<String> getParameterNames() {
		System.out.println("Getting parameterNames from MultipartMap");
	...
	public Map<String, String[]> getParameterMap() {
		System.out.println("Getting parameterMap  from MultipartMap");
	...
	public File getFile(String name) {
		System.out.println("Getting file from MultipartMap");
		Object value = super.get(name);
		if (value instanceof String[]) {
	...
	private String getName(Part part) {
		for (String cd : part.getHeader(CONTENT_DISPOSITION).split(";")) {
			if (cd.trim().startsWith(CONTENT_DISPOSITION_NAME)) {
